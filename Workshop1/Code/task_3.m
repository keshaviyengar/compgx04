...
%pre-allocate solutions and outlier list matrices
solutions = zeros(size(t,1),3);
outlier_list = zeros(size(t,1),size(pseudo_ranges,2));
for epoch=1:size(t,1)
    ...
    %check for outliers
    outlier_list(epoch,:) = Task3(H,d_z);
...
%outliers found at epoch t=360s at satellites:
% 18 with residual -56.1237
% 26 with residual -18.8511
% 28 with residual 30.3173
